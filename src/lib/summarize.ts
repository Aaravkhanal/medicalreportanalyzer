  ...
  properties: {
    ...
    test_explanation: {
      ...
      properties: {
        ...
        overall_indication: { type: "string", description: "What the results indicate (is everything normal or what is abnormal)" },
        actionable_advice: { type: "string", description: "What the user can do to address abnormalities or general health advice based on the report" },
      },
    ...
    medical_conditions: {
      ...
      items: {
        ...
        properties: {
          ...
          explanation: { type: "string", description: "Why this condition is indicated by the report" },
